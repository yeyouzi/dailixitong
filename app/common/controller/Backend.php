...
use app\admin\model\config\Platform;
use fast\Tree;
...
class Backend extends BaseController
{
    ...
    public function _initialize()
    {
        ...
        if($this->banMethod === '*' || in_array($actionname , $this->banMethod)){
            $this->error("暂不开放的功能" , null , null , -1);
        }
     ...
     * @return mixed
     */
    protected function getFirstPlatformId()
    {
        return Platform::getFirstPlatformId();
    }
}
