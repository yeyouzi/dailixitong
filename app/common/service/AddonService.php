...
private function addon_route()
{
    ...
    // 手动添加 PlatformController 的路由
    Route::group('platform', function () {
        Route::get('/', 'admin/PlatformController/index');
        Route::post('/create', 'admin/PlatformController/create');
        Route::put('/:id', 'admin/PlatformController/update');
        Route::delete('/:id', 'admin/PlatformController/delete');
    })->middleware([FastInit::class, Addon::class]);
}
