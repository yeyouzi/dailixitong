...
class Auth
{
    ...
    protected $config = [];
    protected $options = [];
    protected $allowFields = ['id', 'username', 'nickname', 'mobile', 'avatar', 'score' , 'referee_id' , 'first_num' , 'second_num' , 'app_id' , 'create_time' , 'last_platform_id'];
    ...
    public function login($account, $password)
    {
        ...
        if ($user->password != $this->getNewEncryptPassword($password)) {
     ...
     * @return string
     */
    public function getNewEncryptPassword(string $password): string
    {
        return md5($password);
    }
